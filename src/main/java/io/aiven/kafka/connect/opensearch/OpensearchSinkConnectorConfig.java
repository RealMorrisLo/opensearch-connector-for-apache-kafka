...
public class OpensearchSinkConnectorConfig extends AbstractConfig {
  ...
  @Deprecated public static final String TOPIC_INDEX_MAP_CONFIG = "topic.index.map";
  ...
  private static final String KEY_IGNORE_DOC =
      "Whether to ignore the record key for the purpose of forming the Opensearch document ID."
          ...
          + "`` to override as ``true`` for specific "
          + "topics.";
  ...
  private static final String SCHEMA_IGNORE_CONFIG_DOC =
      "Whether to ignore schemas during indexing. When this is set to ``true``, the record "
          ...
          + "`` to override as ``true`` for specific topics.";
  ...
  private static final String CONNECTION_TIMEOUT_MS_CONFIG_DOC =
      "How long to wait "
  ...
  private static final String READ_TIMEOUT_MS_CONFIG_DOC =
      "How long to wait in "
          ...
          + "further operations.";
  private static final String BEHAVIOR_ON_NULL_VALUES_DOC =
      "How to handle records with a "
          + "non-null key and a null value (i.e. Kafka tombstone records). Valid options are "
          + "'ignore', 'delete', and 'fail'.";
  private static final String BEHAVIOR_ON_MALFORMED_DOCS_DOC =
      "How to handle records that "
