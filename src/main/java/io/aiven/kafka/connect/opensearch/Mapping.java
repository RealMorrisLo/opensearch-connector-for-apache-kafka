...
public class Mapping {
  ...
  private static XContentBuilder buildMapping(final Schema schema, final XContentBuilder builder)
      throws IOException {
  ...
  private static XContentBuilder buildMap(final Schema schema, final XContentBuilder builder)
      throws IOException {
  ...
  private static XContentBuilder buildStruct(final Schema schema, final XContentBuilder builder)
      throws IOException {
    builder.startObject(PROPERTIES_FIELD);
  ...
  private static XContentBuilder buildPrimitive(
      final XContentBuilder builder, final String type, final Object defaultValue)
      throws IOException {
    if (type == null) {
  ...
  private static void addTextMapping(final XContentBuilder builder) throws IOException {
    // Add additional mapping for indexing, per
